...
let serializeIds = function(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    res.push(encodeUriComponent(makeString(arr[i])));
  }
  return res.join(',');
};
...
switch (data.pageType) {
  ...
  case 'product.list':
     ...
     *    _category2_{CatID}
     */ 
    specific = '_category2_' + encodeUriComponent(data.category);
    break;
  ...
  case 'product.detail':
     ...
     *    _offer_{ID}
     */
    specific = '_offer' + encodeUriComponent(makeString(prodIds.length ? ('_' + prodIds[0]) : ''));
    break;
  ...
  case 'purchase':
    ...
    specific = '_orderstatus2_' + encodeUriComponent(makeString(data.orderRevenue) + '_' + makeString(data.orderId) + '_') + serializeIds(prodIds) + '&amp;cd=default';
    break;
...
let url = 'https://creativecdn.com/tags?id=pr_'+ encodeUriComponent(data.id) + specific;
...
- name: Page - Home
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa_home';
    const mockData = {
...
- name: Page - List
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa_category2_Category%201%2FCategory%202';
    const mockData = {
      'id': 'aaaaaaaaaaaaaaaaaaaa',
      'pageType': 'list',
      'productIds': [],
...
- name: Page - Product Detail
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa_offer_123';
    const mockData = {
      'id': 'aaaaaaaaaaaaaaaaaaaa',
      'pageType': 'product',
      'productIds': [123],
...
- name: Page - Search Results
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa_listing_1,2,3,4,5';
    const mockData = {
      'id': 'aaaaaaaaaaaaaaaaaaaa',
...
- name: Page - Shopping Cart
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa_basketstatus_1,2,3';
    const mockData = {
      'id': 'aaaaaaaaaaaaaaaaaaaa',
      'pageType': 'cart',
      'productIds': [1,2,3],
...
- name: Page - Initiate Checkout
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa_startorder';
    const mockData = {
      'id': 'aaaaaaaaaaaaaaaaaaaa',
      'pageType': 'cart',
      'productIds': [1,2,3],
...
- name: Page - Payment Info
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa&amp;ncm=1';
    const mockData = {
      'id': 'aaaaaaaaaaaaaaaaaaaa',
      'pageType': 'cart',
      'productIds': [1,2,3],
...
- name: Page - Purchase
  code: |-
    const expectedUrl = 'https://creativecdn.com/tags?id=pr_aaaaaaaaaaaaaaaaaaaa_orderstatus2_198.3_TR7890_1,2,3&amp;cd=default';
